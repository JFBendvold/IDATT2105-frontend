        ...
        <div class="filters">
            ...
            <div class="right">
                ...
                <div class="filter-text-button">
                    ...
                    <span class="filter-text-button-icon" @click="showCategoryDropdown = !showCategoryDropdown">
                    ...
                    <div class="filter-text-button-dropdown" v-if="showCategoryDropdown">
                        <div class="filter-text-button-dropdown-item">
                            ...
                            />
                            <span v-if="categorySuggestion.length > 0" class="filter-text-button-dropdown-item-suggestion" @click="addCategory(categorySuggestion)">
                                {{ categorySuggestion }}
                            </span>
                        </div>
                        <div class="filter-text-button-dropdown-item" v-for="category in selectedCategories" :key="category" @click="removeCategory(category)">
                            <span>{{ category }}</span>
                ...
                <div class="filter-text-button" @click="showStatusDropdown = !showStatusDropdown">
                    ...
                    <div class="filter-text-button-dropdown" v-if="showStatusDropdown">
                        <div class="filter-text-button-dropdown-item" @click="toggleDropdown('status', 'Listed')">
                            <span>Listed</span>
                        </div>
                        <div class="filter-text-button-dropdown-item" @click="toggleDropdown('status', 'Not Listed')">
                ...
                <div class="filter-text-button" @click="showOrderDropdown = !showOrderDropdown">
                    ...
                    <div class="filter-text-button-dropdown" v-if="showOrderDropdown">
                        ...
                        <div class="filter-text-button-dropdown-item" @click="toggleDropdown('order', 'Newest')">
                            <span>Newest</span>
                        </div>
                        <div class="filter-text-button-dropdown-item" @click="toggleDropdown('order', 'Oldest')">
                            <span>Oldest</span>
                        </div>
                    </div>
                </div>
